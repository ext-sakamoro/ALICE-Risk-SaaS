...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100 risk checks/hr', 'Basic VaR (95%)', 'L1 circuit breaker only', 'Community support'] },
  { name: 'Pro', price: '$149/mo', features: ['Unlimited risk checks', 'VaR 95% + 99%', 'L1/L2/L3 circuit breakers', 'Margin calculations', 'Stress testing', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', 'Custom risk models', 'Real-time portfolio monitoring', 'Regulatory reporting', 'SLA 99.999%', 'Dedicated support'] },
];
